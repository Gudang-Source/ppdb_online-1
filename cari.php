            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="box clickable d-flex flex-column justify-content-center mb-0 ">
                        <h3 class="mb-3 ml-5 mr-5" style="color: #248872;">Cetak Hasil Pengumuman PPDB Online Sma Muhammadiyah 4 Kendal</h3>
              ...
              <tbody class="text-center">
                <tr>
                    ...
                    <td>
                        <a href="hasil.php?id=<?= $result['nisn'] ?>" target="blank" class="btn btn-danger" >Cetak</a>
                    </td>
                </tr>
              </tbody>
              <?php
