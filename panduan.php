...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-biru mb-3">
     ...
     <div class="sambutan py-5 mb-5">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="box clickable d-flex flex-column justify-content-center mb-0 ">
                        <h3 class="mb-4" style="color: #248872;">Panduan PPDB Online Sma Muhammadiyah 4 Kendal</h3>
                        ...
                        <?php 
                            ...
                            $query = mysqli_query($koneksi,"SELECT * FROM panduan_ppdb");
                            while($result = mysqli_fetch_assoc ($query)){
                        ?>

                        <ul class="mt-2">
                            <li><?= $result['panduan_ppdb']; ?></li>
                        </ul>
